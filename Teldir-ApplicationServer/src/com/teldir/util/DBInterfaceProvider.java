...
public class DBInterfaceProvider {
    ...
    private static final String url = "jdbc:mysql://localhost:3306/teldir";
    private static final String user = "teldiruser";
    private static final String password = "ellis";
